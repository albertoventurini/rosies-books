...
safe-area padding, minimum-width protection, and text overflow handling. There are no Add Book,
book-detail, year-filter, count, layout-toggle, or mutation controls in this task.
