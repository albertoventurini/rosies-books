...
class BookDetailResourceTest {
  ...
  void rendersAnOwnedBookDetail() {
    ...
    dsl.insertInto(EDITION)
        ...
        .set(EDITION.DESCRIPTION, "First paragraph.\nSecond paragraph.")
    ...
    given()
        ...
        .body(containsString("<h2>Description</h2><p>First paragraph.</p><p>Second paragraph.</p>"))
        .body(not(containsString("<p class=\"preserved-text\">First paragraph.")))
